...
/**
 * @see AsaZend_Crypt_Math_BigInteger_Interface
 */
require_once APD_LIB_DIR . 'AsaZend/Crypt/Math/BigInteger/Interface.php';

/**
 * Support for arbitrary precision mathematics in PHP.
 *
 * AsaZend_Crypt_Math_BigInteger_Bcmath is a wrapper across the PHP BCMath
 * extension.
 *
 * @category   Zend
 * @package    AsaZend_Crypt
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class AsaZend_Crypt_Math_BigInteger_Bcmath implements AsaZend_Crypt_Math_BigInteger_Interface
{
