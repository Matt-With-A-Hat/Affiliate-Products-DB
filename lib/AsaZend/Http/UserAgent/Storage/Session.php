 ...
 */
require_once APD_LIB_DIR . 'AsaZend/Http/UserAgent/Storage.php';

/**
 * @see AsaZend_Session_Namespace
 */
require_once APD_LIB_DIR . 'AsaZend/Session/Namespace.php';
...
class AsaZend_Http_UserAgent_Storage_Session implements AsaZend_Http_UserAgent_Storage 
{
    ...
    public function __construct($options = null) 
    {
        ...
        if (null !== $options && !is_array($options)) {
            require_once APD_LIB_DIR . 'AsaZend/Http/UserAgent/Storage/Exception.php';
