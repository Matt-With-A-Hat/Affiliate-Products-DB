 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class AsaZend_Service_Amazon_Item
{
    /**
     * @var string
     */
    ...
    {
        if (null === $dom) {
            require_once APD_LIB_DIR . 'AsaZend/Service/Amazon/Exception.php';
...
//             */
//            require_once APD_LIB_DIR . 'AsaZend/Service/Amazon/CustomerReview.php';
...
//        }
    ...
    protected function _searchValue ($itemXml, $s)
    {
        switch ($s) {
            case 'Languages':
                require_once APD_LIB_DIR . 'AsaZend/Service/Amazon/Language.php';
                $resultObj = new AsaZend_Service_Amazon_Language($itemXml);
                return $resultObj->getResult();
                break;
            case 'Subtitles':
                require_once APD_LIB_DIR . 'AsaZend/Service/Amazon/Subtitles.php';
