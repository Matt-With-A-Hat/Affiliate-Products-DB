...
class AsaZend_Service_Amazon_OfferSet
{
     ...
     * @var string
     */
    public $LowestNewPriceFormattedPrice;
    ...
    public function __construct(DOMElement $dom)
    {
        ...
        $xpath->registerNamespace('az', 'http://webservices.amazon.com/AWSECommerceService/'. Apd_Service_Amazon::$api_version);
        ...
        if ($offer->length == 1) {
            ...
            if ($lowestNewPrice->length == 1) {
                ...
                $this->LowestNewPriceFormattedPrice = (string) $xpath->query('./az:OfferSummary/az:LowestNewPrice/az:FormattedPrice/text()', $dom)->item(0)->data;
            }
            ...
            if ($lowestUsedPrice->length == 1) {
                ...
                $this->LowestUsedPriceFormattedPrice = (string) $xpath->query('./az:OfferSummary/az:LowestUsedPrice/az:FormattedPrice/text()', $dom)->item(0)->data;
            }
        ...
        if ($offers->length >= 1) {
            ...
            if ($xpath->query('./az:Offers/az:Offer/az:OfferListing/az:SalePrice', $dom)->length > 0) {
