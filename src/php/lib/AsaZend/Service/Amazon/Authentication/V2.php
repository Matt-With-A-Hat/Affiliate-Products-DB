 ...
 */
require_once APD_LIB_DIR . 'AsaZend/Service/Amazon/Authentication.php';

/**
 * @see AsaZend_Crypt_Hmac
 */
require_once APD_LIB_DIR . 'AsaZend/Crypt/Hmac.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class AsaZend_Service_Amazon_Authentication_V2 extends AsaZend_Service_Amazon_Authentication
{
    /**
     * Signature Version
     */
    ...
    protected function _signParameters($url, array &$paramaters)
    {
        ...
        $hmac = AsaZend_Crypt_Hmac::compute($this->_secretKey, 'SHA256', $data, AsaZend_Crypt_Hmac::BINARY);
