 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class AsaZend_Validate_Alpha extends AsaZend_Validate_Abstract
{
     ...
     * @return AsaZend_Filter_Alpha Provides a fluent interface
     */
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see AsaZend_Filter_Alpha
             */
            require_once APD_LIB_DIR . 'AsaZend/Filter/Alpha.php';
            self::$_filter = new AsaZend_Filter_Alpha();
        }
