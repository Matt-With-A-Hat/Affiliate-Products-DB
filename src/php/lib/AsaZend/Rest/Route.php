 ...
 */
require_once APD_LIB_DIR . 'AsaZend/Controller/Router/Route/Interface.php';

/**
 * @see AsaZend_Controller_Router_Route_Module
 */
require_once APD_LIB_DIR . 'AsaZend/Controller/Router/Route/Module.php';

/**
 * @see AsaZend_Controller_Dispatcher_Interface
 */
require_once APD_LIB_DIR . 'AsaZend/Controller/Dispatcher/Interface.php';

/**
 * @see AsaZend_Controller_Request_Abstract
 */
require_once APD_LIB_DIR . 'AsaZend/Controller/Request/Abstract.php';
